...
export default function PriceListForm() {
  ...
  if (!isSuperAdmin) {
    return (
      <div className="p-8 text-stone-400">Bu sayfaya erişim yetkiniz yok.</div>
    );
  }
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          ...
          try {
            ...
            if (data.success) {
              setMessage({
                text: "Fiyat listesi oluşturuldu",
                type: "success",
              });
              ...
              <div className="flex flex-wrap gap-2">
                {makes.map((mk) => (
                  ...
                  >
                    ...
                    <span className="text-[11px] font-semibold text-center text-stone-200">
                      {mk.label}
                    </span>
                  </button>
                ))}
                    ...
                    <>
                      <div className="flex flex-wrap gap-2">
                        {products
                          ...
                          .map((product) => {
                            const isSelected = values.selectedProducts.includes(
                              product._id,
                            );
                            return (
                              <button
